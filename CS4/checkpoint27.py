# ติดตาม Pender Spellbane เพื่อเรียนรู้ความลับของเธอ

while True:
    # เพนเดอร์เป็นเพื่อนเพียงคนเดียวที่นี่ ดังนั้นเธอจึงอยู่ใกล้ที่สุดเสมอ
    pender = hero.findNearest(hero.findFriends())

    if pender:
        # moveXY() จะย้ายไปยังตำแหน่งที่ Pender อยู่
        # แต่หล่อนจะย้ายออกไปเมื่อคุณไปถึงที่นั่น
     
        # move() ขยับทีละขั้นเท่านั้น
        # เพื่อให้คุณสามารถใช้ติดตามเป้าหมายของคุณได้
